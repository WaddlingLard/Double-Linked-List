...
public class ListTester {
	...
	private void runTests() {
		...
		String STRING_BA = "BA";
		Integer[] LIST_AB = {ELEMENT_A, ELEMENT_A};
		String STRING_AB = "AB";
		...
		testSingleElementList(emptyList_addToRearA_A, "emptyList_addToRearA_A", LIST_A, STRING_A); //ADDED
		testSingleElementList(emptyList_addA_A, "emptyList_addA_A", LIST_A, STRING_A); //ADDED
		testSingleElementList(emptyList_add0A_A, "emptyList_add0A_A", LIST_A, STRING_A); //ADDED
		//1-element to empty list
		testEmptyList(A_removeFirst_emptyList, "A_removeFirst_emptyList"); //ADDED
		testEmptyList(A_remove0_emptyList, "A_remove0_emptyList"); //ADDED
		testEmptyList(A_removeLast_emptyList, "A_removeLast_emptyList"); //ADDED
		testEmptyList(A_removeA_emptyList, "A_removeA_emptyList"); //ADDED
		testEmptyList(A_iteratorRemoveAfterNextA_emptyList, "A_iteratorRemoveAfterNextA_emptyList"); //ADDED
		//1-element to 2-element
		testTwoElementList(A_addToFrontB_BA, "A_addToFrontB_BA", LIST_BA, STRING_BA); //ADDED
		testTwoElementList(A_addToRearB_AB, "A_addToRearB_AB", LIST_AB, STRING_AB); //ADDED (UNSURE WHY BUT SEVERAL TESTS ARE FAILING FOR THIS SPECIFIC CASE)
		testTwoElementList(A_addAfterBA_AB, "A_addAfterBA_AB", LIST_AB, STRING_AB); //ADDED
		testTwoElementList(A_add0B_BA, "A_add0B_BA", LIST_BA, STRING_BA); //ADDED
		testTwoElementList(A_iteratorAddB_BA, "A_iteratorAddB_BA", LIST_BA, STRING_BA); //ADDED
		//1-element to changed 1-element via set()
		testSingleElementList(A_set0B_B, "A_set0B_B", LIST_B, STRING_B); //ADDED
		testSingleElementList(A_iteratorSetBAfterB, "A_iteratorSetBAfterB", LIST_B, STRING_B);
		//2-element to 1-element
		testSingleElementList(AB_removeFirst_B, "AB_removeFirst_B", LIST_B, STRING_B); //ADDED
		testSingleElementList(AB_remove1_A, "AB_remove1_A", LIST_A, STRING_A); //ADDED
		testSingleElementList(AB_removeLast_A, "AB_removeLast_A", LIST_A, STRING_A); //ADDED
		testSingleElementList(AB_iteratorRemoveAfterNextA_B, "AB_iteratorRemoveAfterNextA_B", LIST_B, STRING_B); //ADDED
		testSingleElementList(AB_iterator1RemoveAfterNextB_A, "AB_iterator1RemoveAfterNextB_A", LIST_A, STRING_A ); //ADDED (A METHOD NEEDS FIXING FOR THIS TO WORK)
		//2-element to 3-element
		testThreeElementList(AB_addToRearC_ABC, "AB_addToRearC_ABC", LIST_ABC, STRING_ABC); //ADDED
		testThreeElementList(AC_set2B_ACB, "AC_set2B_ACB", LIST_ACB, STRING_ACB); //ADDED
		testThreeElementList(AB_addToFrontC_CAB, "AB_addToFrontC_CAB", LIST_CAB, STRING_CAB); //ADDED 
		testThreeElementList(AB_iterator1AddCAfterPreviousA_CAB, "AB_iterator1AddCAfterPreviousA_CAB", LIST_CAB, STRING_CAB); //ADDED
		//2-element to changed 2-element via set()
		testTwoElementList(AB_set1C_AC, "AB_set1C_AC", LIST_AC, STRING_AC); //ADDED
		testTwoElementList(AB_set0C_CB, "AB_set0C_CB", LIST_CB, STRING_CB); //ADDED
		testTwoElementList(AB_iteratorSetCAfterPreviousA_CB, "AB_iteratorSetCAfterPreviousA_CB", LIST_CB, STRING_CB); //ADDED
	 ...
	 * @return [] after the call to next() and remove()
	 */
	private IndexedUnsortedList<Integer> A_iteratorRemoveAfterNextA_emptyList(){
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
	...
	private Scenario<Integer> A_iteratorRemoveAfterNextA_emptyList = () -> A_iteratorRemoveAfterNextA_emptyList();
	 ...
	 * @return [B] after next() and set(B)
	 */
	private IndexedUnsortedList<Integer> A_iteratorSetBAfterB(){
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator list1 = list.listIterator();
		list1.next();
		list1.set(ELEMENT_B);
	...
	private Scenario<Integer> A_iteratorSetBAfterB = () -> A_iteratorSetBAfterB();
	 ...
	 * @return [B] after the call to next() and remove()
	 */
	private IndexedUnsortedList<Integer> AB_iteratorRemoveAfterNextA_B(){
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator list1 = list.listIterator();
		list1.next();
		list1.remove();
	...
	private Scenario<Integer> AB_iteratorRemoveAfterNextA_B = () -> AB_iteratorRemoveAfterNextA_B();

	/** Scenario [A,B] -> iterator(1) remove() anfter next() returns B -> [A]
	 * @return [B] after the call to next() and remove();
	 */
	private IndexedUnsortedList<Integer> AB_iterator1RemoveAfterNextB_A(){
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator list1 = list.listIterator(1);
		list1.next();
		list1.remove();
		return list;
	}
	private Scenario<Integer> AB_iterator1RemoveAfterNextB_A = () -> AB_iteratorRemoveAfterNextA_B();
	...
	/** Scenario [A,C] -> set(2,B) -> [A,C,B]
	 * @return [A,C,B] after set(2,B) 
	 */
	private IndexedUnsortedList<Integer> AB_set2B_ACB(){
		IndexedUnsortedList<Integer> list = AB_set1C_AC();
		list.set(2, ELEMENT_B);
		return list;
	}
	private Scenario<Integer> AC_set2B_ACB = () -> AB_set2B_ACB();

	/** Scenario [A,B] -> iterator(1) add(C) after previous() returns A -> [C,A,B]
	 * @return [C,A,B] after previous and add(C)
	 */
	private IndexedUnsortedList<Integer> AB_iterator1AddCAfterPreviousA_CAB(){
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator list1 = list.listIterator();
		list1.previous();
		list1.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_iterator1AddCAfterPreviousA_CAB = () -> AB_iterator1AddCAfterPreviousA_CAB();
	...
	/** Scenario [A,B] -> iterator(1) set(C) after previous() returns A -> [C,B]
	 * @return [C,B] after previous() and set(C)
	 */
	private IndexedUnsortedList<Integer> AB_iteratorSetCAfterPreviousA_CB(){
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator list1 = list.listIterator(1);
		list1.previous();
		list1.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_iteratorSetCAfterPreviousA_CB = () -> AB_iteratorSetCAfterPreviousA_CB();
	...
	/** Scenario [A,B,C] -> iterator(1) remove() after next() returns B -> [A,C}
	 * @return [A,C] after remove() and next()
	 */
	private IndexedUnsortedList<Integer> ABC_iterator1RemoveAfterNextB_AC(){
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		ListIterator list1 = list.listIterator(1);
		list1.next();
		list1.remove();
	...
	private Scenario<Integer> ABC_iterator1RemoveAfterNextB_AC = () -> ABC_iterator1RemoveAfterNextB_AC();
	...
	/** Scenario [A,B,C] -> iterator(2) set(D) after previous() returns B -> [A,D,C]
	 * @return [A,D,C] after previous() and set(D)
	 */
	private IndexedUnsortedList<Integer> ABC_iterator2SetDAfterPreviousB_ADC(){
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		ListIterator list1 = list.listIterator(2);
		list1.previous();
		list1.set(ELEMENT_D);
		return list;
	}
	private Scenario<Integer> ABC_iterator2SetDAfterPreviousB_ADC = () -> ABC_iterator2SetDAfterPreviousB_ADC();
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			printTest(scenarioName + "_testIterNext", testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_iterNext_testIterNext", testIterNext(iterAfterNext(scenario.build(), 1), 1, Result.MatchingValue));
			printTest(scenarioName + "_iterNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 1), Result.NoException));
			printTest(scenarioName + "_iterNextNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 2), Result.NoException));
			printTest(scenarioName + "_iterNextRemove_testIterNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), null , Result.NoSuchElement));
